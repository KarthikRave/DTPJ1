...
<ul id="p02" style="z-index:500;">
  <li id="p03"><a href="${pageContext.request.contextPath}/index">Home</a></li>
  <li id="p03"><a href="${pageContext.request.contextPath}/aboutus">Our Service</a></li> 
  ...
  <%
    			...
    			{
    			%>
  <li id="p03"><a href="${pageContext.request.contextPath}/initiateFlow">View Cart</a></li>
  <%
    			}
				%>
  	<c:choose>
  		...
  		<li id="p04"><a href="${pageContext.request.contextPath}/loginpage">Login</a></li>
  		</c:otherwise>
