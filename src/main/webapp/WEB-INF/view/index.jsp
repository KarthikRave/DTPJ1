...
<div class="container">
  <div class="row">
    <div class="col-sm-4">
      <h3>Carrot Halwa</h3>
      <img class="img-circle"; src="${pageContext.request.contextPath}/resources/image/carrot halwa.jpg" alt="Carrot"; style="width:180px; height:140px;">
    ...
    <div class="col-sm-4">
      <h3>Badam Halwa</h3>
      <img class="img-circle"; src="${pageContext.request.contextPath}/resources/image/badam halwa.jpg" alt="Badam"; style="width:180px; height:140px;">
    ...
    <div class="col-sm-4">
      <h3>Kaju Katli</h3>
      <img class="img-circle"; src="${pageContext.request.contextPath}/resources/image/img1.jpg" alt="Kaju"; style="width:180px; height:140px;">
